            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="data_jadwal.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Data Jadwal Dokter
                        </a>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if ($_SESSION['admin'] == True) {
                                ...
                                <tbody>
                                    <?php
                                    $ambildatadokter = mysqli_query($koneksi, "SELECT * FROM data_jadwal_dokter");
                                    $i = 1;
                                    while ($data = mysqli_fetch_array($ambildatadokter)) {
                                        $ijd = $data['id_jadwal_dokter'];
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $i++; ?></td>
                                            <td><?= $nama_dokter; ?></td>
                                            <td><?= $tanggal_jadwal; ?></td>
                                            <td><?= $jam_jadwal; ?></td>
                                            <td></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $ijd; ?>">Edit</button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $ijd; ?>">Delete</button>
                                            </td>
                                        </tr>
                                        <!-- Edit Modal -->
                                        <div class="modal" id="edit<?= $ijd; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <input type="text" name="nama_dokter" value="<?= $nama_dokter; ?>" class="form-control" required>
                                                        <br>
                                                        <input type="date" name="tanggal_jadwal" value="<?= $tanggal_jadwal; ?>" class="form-control" required>
                                                        <br>
                                                        <input type="time" name="jam_jadwal" value="<?= $jam_jadwal; ?>" class="form-control" required>
                                                        <br>  
                                                            <input type="hidden" name="ijd" value="<?= $ijd; ?>">
                                        ...
                                        <div class="modal" id="delete<?= $ijd; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            Apakah Yakin Hapus Pasien <?= $nama_dokter; ?> ?
                                                            <br>
                                                            <input type="hidden" name="ijd" value="<?= $ijd; ?>">
                                                            <br>
