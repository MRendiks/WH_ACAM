                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if ($_SESSION['admin'] == True) {
                                ...
                                <tbody>
                                    <?php
                                    $data_pendaftaran = mysqli_query($koneksi, "SELECT pasien.nama_pasien, pasien.tgl_lahir, data_jadwal_dokter.nama_dokter, antrian.no_antrian, antrian.id_antrian, data_jadwal_dokter.tanggal_jadwal, pasien.NIK, pasien.tempat_lahir, pasien.alamat, pasien.no_tlp
                                    FROM pasien
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $no_antrian; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $ida; ?>">Edit</button>
